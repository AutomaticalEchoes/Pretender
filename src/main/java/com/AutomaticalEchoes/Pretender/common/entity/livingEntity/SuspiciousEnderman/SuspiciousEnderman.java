...
public class SuspiciousEnderman extends Monster {
    ...
    private static final Integer PERSISTENT_SCARE_TIME = 60 * 20;
...
//        super.positionRider(p_19957_);
    ...
    @Override
    public void tick() {
        if(this.CarryNothing() && !isAngry() && tickCount > lastJokeTime + 6000 ) angry = Pretender.RANDOM.nextInt(3600) < (tickCount - lastJokeTime)/20;
        if(this.isScared()){
    ...
    protected void actuallyHurt(DamageSource p_21240_, float p_21241_) {
        ...
        this.stopCatching();
        this.teleport();
        this.setAngry(Pretender.RANDOM.nextInt(100) < 1);
    }
