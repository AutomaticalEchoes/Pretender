...
public class IRenderType extends RenderType {
    ...
    private static final Function<ResourceLocation, RenderType> IType = Util.memoize((p_173253_) -> {
        ...
        return create("itype", DefaultVertexFormat.NEW_ENTITY, VertexFormat.Mode.QUADS, 256, false, true, RenderType.CompositeState.builder().setShaderState(RENDERTYPE_EYES_SHADER).setTextureState(renderstateshard$texturestateshard).setTransparencyState(TRANSLUCENT_TRANSPARENCY).createCompositeState(false));
    });
