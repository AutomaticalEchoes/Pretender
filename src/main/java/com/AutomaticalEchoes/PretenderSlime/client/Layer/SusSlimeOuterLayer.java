package com.AutomaticalEchoes.PretenderSlime.client.Layer;

import com.AutomaticalEchoes.PretenderSlime.api.IRenderType;
...
public class SusSlimeOuterLayer <T extends LivingEntity> extends RenderLayer<T, SusSlimeModel<T>> {
    private final EntityModel<T> model;

    public SusSlimeOuterLayer(RenderLayerParent<T, SusSlimeModel<T>> p_174536_, EntityModelSet p_174537_) {
        super(p_174536_);
        this.model = new SusSlimeModel<>(p_174537_.bakeLayer(SusSlimeModel.LAYER_LOCATION_SLIME_OUTER));
    }
    ...
    public void render(PoseStack p_117470_, MultiBufferSource p_117471_, int p_117472_, T p_117473_, float p_117474_, float p_117475_, float p_117476_, float p_117477_, float p_117478_, float p_117479_) {
        ...
        if (!p_117473_.isInvisible() || flag) {
            ...
            if (flag) {
                ...
                vertexconsumer = p_117471_.getBuffer(IRenderType.entityTranslucent(this.getTextureLocation(p_117473_)));
            }
