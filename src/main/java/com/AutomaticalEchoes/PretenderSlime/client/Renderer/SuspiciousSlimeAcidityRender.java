package com.AutomaticalEchoes.PretenderSlime.client.Renderer;

import com.AutomaticalEchoes.PretenderSlime.common.entity.projectile.AcidityBall;
...
public class SuspiciousSlimeAcidityRender extends EntityRenderer<AcidityBall> {
    ...
    protected int getBlockLightLevel(AcidityBall p_114087_, BlockPos p_114088_) {
        return 15;
    }

    public void render(AcidityBall p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        p_114083_.pushPose();
    ...
    public ResourceLocation getTextureLocation(AcidityBall p_114078_) {
